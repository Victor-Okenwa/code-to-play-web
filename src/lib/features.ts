...
export const FEATURES = [
  ...
  },
  {
    ...
    body: `Games open as a webview. Spend a play without leaving your files or your cursor. Free includes ${formatGameList(FREE_GAMES)}. Pro adds ${PRO_UPCOMING_GAMES}, with a ${PRO_TRIAL_COPY}.`,
    home: false,
  },
  {
    id: "works-offline",
